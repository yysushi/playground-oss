...
```
koketani: ~/g/g/k/p/envoy (envoy !?)$ docker run --rm --name envoy -p 9901:9901 -p 10000:10000 -v $(pwd)/started:/started -i -t envoyproxy/envoy-dev -c /started/envoy-demo.yaml
```
